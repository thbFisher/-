...
define(function (require, exports, module) {
	...
	var template = require('text!view/knowledge/tpl/question.html');
	...
	var View = Backbone.View.extend({
		el: 'body',
        events: {
            'keyup .input-question': 'countText',
        ...
        validSubmit: function(){
            ...
            var type = $.trim(this.$('.input-select-type').val());
			var text = $.trim(this.$('.input-question').val());
        ...
        initType: function(){
            ...
            businessDelegate.getKnowledgeQuestionType(_.bind(function(data){
                 ...
                 this.$('.btn-submit').prop('disabled', false);
                 this.$('.btn-input-camera').removeClass('disabled');
            },this),_.bind(function(err){
                $.hideLoading();
                $.jtoast(err);
            },this))
		...
		initialize: function () {
            ...
            this.$typeInput = this.$('.input-select-type');
