...
define(function (require, exports, module) {
	...
	var template = require('text!view/read/tpl/info.html');
	...
	var View = Backbone.View.extend({
		...
		viewAttachment: function(){
			Backbone.history.navigate('read-attachment/'+this.uuid, { trigger: true });
		},
		getInfo: function(){
			$.showLoading();
		...
		backbutton: function () {
            Backbone.history.navigate('read-index', { trigger: true });
		},
		initialize: function (opitons) {
			...
			this.$wrapper = this.$('.info-wrapper');
		},
		render: function () {
			this.getInfo();
			return this;
